                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div className="glass-card rounded-2xl p-6 glow-border-popular relative flex flex-col justify-between spring-bounce group">
                                    ...
                                    <button
                                        ...
                                        className="mean-bird-button active relative w-full py-3 px-6 text-[var(--accent-color)] font-bold rounded-xl mt-8 shadow-lg text-sm flex items-center justify-between"
                                    >
