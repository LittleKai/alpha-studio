export default {
  workflow: {
    ...
    sidebar: {
      ...
      skillsLibrary: "Thư Viện Kỹ Năng AI",
      exitStudio: "Thoát Studio"
    },
    skillsAdmin: {
      title: "Thư Viện Kỹ Năng AI",
      subtitle: "Chỉnh sửa các skill đang hiển thị tại /studio/ai-skills",
      openLibrary: "Mở thư viện công khai",
      allCategories: "Tất cả danh mục",
      allTiers: "Tất cả cấp độ",
      results: "skill",
      empty: "Không có skill nào khớp bộ lọc.",
      retry: "Thử lại",
      loading: "Đang tải...",
      edit: "Sửa",
      delete: "Xoá",
      prev: "Trước",
      next: "Sau",
      adminOnly: "Chỉ admin mới sửa được thư viện kỹ năng.",
      editTitle: "Chỉnh sửa Skill",
      cancel: "Huỷ",
      update: "Cập nhật",
      saving: "Đang lưu...",
      ...
      fields: {
        ...
        name: "Tên skill",
        author: "Tác giả",
        headlineVi: "Tiêu đề phụ (Tiếng Việt)",
        headlineEn: "Tiêu đề phụ (Tiếng Anh)",
        ...
        timeSaving: "Thời gian tiết kiệm",
        githubStars: "Sao GitHub",
        installCommand: "Lệnh cài đặt",
        sourceRepoUrl: "URL kho nguồn",
        url: "URL skill",
        source: "Nguồn",
        worksWith: "Tương thích với",
        worksWithPlaceholder: "Thêm công cụ...",
        tags: "Thẻ",
        tagsPlaceholder: "Thêm thẻ...",
        overviewVi: "Tổng quan (Tiếng Việt)",
        overviewEn: "Tổng quan (Tiếng Anh)",
        setupVi: "Cài đặt (Tiếng Việt)",
        setupEn: "Cài đặt (Tiếng Anh)",
        usageVi: "Cách dùng (Tiếng Việt)",
        usageEn: "Cách dùng (Tiếng Anh)",
        requirements: "Yêu cầu",
        requirementsPlaceholder: "Thêm yêu cầu...",
        relatedSkills: "Skill liên quan",
        relatedSkillsPlaceholder: "Thêm slug skill..."
      },
      errors: {
        nameRequired: "Tên skill không được để trống",
        categoryRequired: "Danh mục không được để trống",
        saveFailed: "Không lưu được skill",
        loadFailed: "Không tải được danh sách skill",
    ...
    dashboard: {
      ...
      downloadError: "Không thể tải file. Vui lòng thử lại.",
      ...
      docPanel: {
        ...
        deleteConfirmTitle: "Xác nhận xóa file",
        deleteConfirmMessage: "Nhập lại tên file để xác nhận xóa vĩnh viễn:",
        deleteConfirmPlaceholder: "Nhập tên file...",
