    ...
    hub: {
      ...
      cards: {
        ...
        crm: {
          ...
          page: {
            tag: "Hệ sinh thái Zalo Marketing & CRM",
            title: "Alpha CRM cho Windows & Android",
            subtitle: "Giải pháp tự động hóa phễu tiếp thị, gửi tin nhắn hàng loạt và chăm sóc khách hàng tự động tối ưu chi phí qua nền tảng Zalo. Tích hợp trợ lý AI thông minh và cơ chế ghép nối tài khoản an toàn.",
            downloadTitle: "Tải bộ cài đặt Client & Connectors",
            downloadDesc: "Bản cài đặt Windows Client và ứng dụng ghép nối di động Android APK để bắt đầu chiến dịch.",
            downloadWindows: "Tải cho Windows",
            downloadAndroid: "Tải Android APK",
            downloadAndroidNotice: "Bản Android APK hiện đang trong giai đoạn thử nghiệm (demo), tính năng kết nối đầy đủ khuyến nghị dùng trên Windows.",
            betaBadge: "Beta",
            demoBadge: "Demo",
            ...
            updateNote: "Sau khi cài đặt trên Windows, ứng dụng tự động kết nối và đồng bộ dữ liệu chiến dịch của bạn.",
            viewPricing: "Xem bảng giá & Gói cước",
            pricingHeading: "Gói dịch vụ & Hạn mức AI",
            pricingDesc: "Sở hữu gói giấy phép vận hành hoặc nạp thêm lượt sử dụng AI độc lập bất kỳ lúc nào.",
            manageSubscription: "Quản lý gói cước & Ví AI",
            monthlyPlanName: "Giấy phép Alpha CRM 1 Tháng",
            monthlyPlanDesc: "Kích hoạt đầy đủ tính năng bot, bao gồm 100 yêu cầu AI mỗi tháng.",
            screenshotsHeading: "Giao diện ứng dụng",
            prevShot: "Ảnh trước",
            nextShot: "Ảnh tiếp theo",
            shot1: "Dashboard tổng quan theo dõi hiệu suất chiến dịch và tin nhắn Zalo",
            shot2: "Quản lý danh bạ, gắn nhãn (tags) và phân loại khách hàng",
            shot3: "Soạn thảo kịch bản và gửi tin nhắn tự động hàng loạt",
            shot4: "Trợ lý AI tối ưu nội dung và tự động tương tác thông minh",
            featuresHeading: "Điểm nổi bật",
            featureBulkTitle: "Gửi tin nhắn hàng loạt",
            featureBulkDesc: "Soạn thảo kịch bản, đính kèm tệp khách hàng tiềm năng và lên lịch gửi tin tự động giãn cách an toàn.",
            featureAiTitle: "Trợ lý AI kịch bản",
            featureAiDesc: "Tự động tối ưu nội dung, cá nhân hóa tin nhắn và phản hồi khách hàng theo ngữ cảnh thông minh.",
            featurePairingTitle: "Ghép nối tài khoản an toàn",
            featurePairingDesc: "Cơ chế pairing QR Code giữa thiết bị Android và máy tính Windows, không lo khóa tài khoản.",
            featureContactsTitle: "Quản lý phễu & Gắn nhãn",
            featureContactsDesc: "Phân loại khách hàng theo nhóm, gắn tag đa tầng và theo dõi lịch sử tương tác chi tiết.",
            requirementsHeading: "Yêu cầu & lưu ý",
            requirementWindows: "Windows 10 trở lên, bản 64-bit.",
            requirementAndroid: "Android: Android 8.0 trở lên để chạy ứng dụng connector pairing.",
            requirementZalo: "Tài khoản Zalo cá nhân hoặc Zalo Official Account.",
            requirementMemory: "Tối thiểu 4GB RAM, khuyến nghị 8GB RAM.",
            requirementSize: "Bộ cài Windows Client nhẹ nhàng ~80MB."
          }
        },
        vocab: {
          title: "VocabFlip",
          ...
          page: {
            ...
            downloadTitle: "Trải nghiệm & Tải ứng dụng",
            downloadDesc: "Học trực tiếp trên Web hoặc tải bộ cài đặt Windows và Android APK để học ngoại tuyến.",
            downloadWindows: "Tải cho Windows",
            quickApk: "Tải APK",
            downloadAndroid: "Tải Android APK",
            ...
            releaseDate: "Cập nhật {{date}}",
            updateNote: "Hỗ trợ lưu trữ offline, đồng bộ tiến độ học tập và tự động cập nhật khi có phiên bản mới.",
            screenshotsHeading: "Giao diện ứng dụng",
            prevShot: "Ảnh trước",
            nextShot: "Ảnh tiếp theo",
            shot1: "Thư viện bộ thẻ từ vựng cộng đồng và cá nhân đa dạng",
            shot2: "Chế độ ôn tập Flashcard trắc nghiệm kết hợp thuật toán FSRS",
            shot3: "Luyện viết Hán tự (Kanji) theo từng nét chuẩn xác",
            shot4: "Tra cứu từ điển StarDict offline tích hợp nhanh chóng",
            featuresHeading: "Điểm nổi bật",
            ...
            featureFsrsTitle: "Thuật toán giãn cách FSRS",
            featureFsrsDesc: "Tối ưu hoá đường cong quên lãng, tự động nhắc nhở thời điểm vàng để ôn tập hiệu quả gấp 10 lần.",
            featureImportTitle: "Nhập / Xuất Anki & Excel",
            featureImportDesc: "Hỗ trợ nhập và xuất các bộ thẻ từ Anki, Excel, CSV một cách nhanh chóng và tiện lợi.",
            requirementsHeading: "Yêu cầu & nền tảng",
            requirementWeb: "Trình duyệt Web: Chrome, Edge, Firefox, Safari hiện đại (không cần cài đặt).",
            requirementOs: "Windows 10 trở lên, bản 64-bit (bản cài đặt hoặc portable).",
            requirementAndroid: "Android: Android 8.0 trở lên, tối ưu cho điện thoại & máy tính bảng.",
            requirementAlgorithm: "Thuật toán FSRS-4.5 hiện đại giúp ghi nhớ từ vựng vào trí nhớ dài hạn.",
            requirementSize: "Bộ cài nhẹ nhàng ~50MB, tra cứu từ điển offline không cần kết nối mạng.",
