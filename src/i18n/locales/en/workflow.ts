export default {
  workflow: {
    ...
    wallet: {
      ...
      guide: {
        title: "How to Top Up",
        step1: "Select a Credits package below",
        step2: "Scan the QR code or transfer manually",
        step3: "Enter the exact transfer note",
        step4: "Credits will be added automatically within 1-5 minutes",
        support: "Supported: Momo, ZaloPay can scan bank QR codes"
      },
      pkgServer: "Rent GPU Server",
      pkgCourse: "Buy Courses",
      pkgJob: "Post Jobs",
      selectPkg: "Select this plan",
      processing: "Processing...",
      historyShow: "View transaction history",
      ...
      statusTimeout: "Expired",
      payTitle: "Payment",
      transferContent: "Transfer note",
      copy: "Copy",
      copied: "Copied!",
      cancelPay: "Cancel",
      confirmedTransfer: "I have transferred",
      paySuccess: "Transaction recorded. Please wait for system confirmation (1-5 min).",
      errorClose: "Close",
