export default {
  workflow: {
    ...
    sidebar: {
      ...
      skillsLibrary: "AI Skills Library",
      exitStudio: "Exit Studio"
    },
    skillsAdmin: {
      title: "AI Skills Library",
      subtitle: "Edit the skill entries shown at /studio/ai-skills",
      openLibrary: "Open public library",
      ...
      prev: "Previous",
      next: "Next",
      adminOnly: "Only admins can edit the skills library.",
      ...
      fields: {
        ...
        name: "Skill name",
        author: "Author",
        headlineVi: "Headline (Vietnamese)",
        ...
        timeSaving: "Estimated time saving",
        githubStars: "GitHub stars",
        installCommand: "Install command",
        sourceRepoUrl: "Source repository URL",
        url: "Skill URL",
        source: "Source",
        worksWith: "Works with",
        worksWithPlaceholder: "Add a tool...",
        tags: "Tags",
        tagsPlaceholder: "Add a tag...",
        overviewVi: "Overview (Vietnamese)",
        overviewEn: "Overview (English)",
        setupVi: "Setup (Vietnamese)",
        setupEn: "Setup (English)",
        usageVi: "Usage (Vietnamese)",
        usageEn: "Usage (English)",
        requirements: "Requirements",
        requirementsPlaceholder: "Add a requirement...",
        relatedSkills: "Related skills",
        relatedSkillsPlaceholder: "Add a skill slug..."
      },
      errors: {
