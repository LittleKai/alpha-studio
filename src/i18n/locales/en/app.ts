    ...
    hub: {
      ...
      cards: {
        ...
        crm: {
          ...
          page: {
            tag: "Zalo Marketing & CRM Ecosystem",
            title: "Alpha CRM for Windows & Android",
            subtitle: "Cost-effective solution for marketing funnels automation, bulk messaging, and auto customer care over the Zalo platform. Powered by smart AI assistant and secure device pairing.",
            downloadTitle: "Download Client & Connectors",
            downloadDesc: "Windows Client setup and mobile Android pairing connector APK to launch your marketing campaigns.",
            downloadWindows: "Download for Windows",
            downloadAndroid: "Download Android APK",
            downloadAndroidNotice: "The Android APK is currently in demo preview; the full feature set is recommended on Windows.",
            betaBadge: "Beta",
            demoBadge: "Demo",
            releaseLoading: "Checking version...",
            releaseVersion: "Version {{version}}",
            releaseDate: "Updated {{date}}",
            releaseFallback: "Could not read release metadata, falling back to backup download link.",
            updateNote: "Once installed on Windows, the app connects and syncs your campaign data seamlessly.",
            viewPricing: "View Plans & Pricing",
            pricingHeading: "Plans & AI Quotas",
            pricingDesc: "Subscribe to an operational license or top up AI requests on demand anytime.",
            manageSubscription: "Manage Plans & AI Wallet",
            monthlyPlanName: "Alpha CRM 1-Month License",
            monthlyPlanDesc: "Full bot automation features, including 100 AI requests per month.",
            screenshotsHeading: "Inside the app",
            prevShot: "Previous screenshot",
            nextShot: "Next screenshot",
            shot1: "Dashboard tracking campaign performance and Zalo messaging metrics",
            shot2: "Contact management, tags classification, and customer segmentation",
            shot3: "Script sequencing and automated scheduled bulk messaging",
            shot4: "AI script assistant for copy optimization and intelligent interactions",
            featuresHeading: "Highlights",
            featureBulkTitle: "Bulk messaging",
            featureBulkDesc: "Draft sequences, import lead lists, and schedule safe automated spaced message delivery.",
            featureAiTitle: "AI script assistant",
            featureAiDesc: "Automatically optimize copy, personalize messages, and intelligently respond to customers.",
            featurePairingTitle: "Secure device pairing",
            featurePairingDesc: "QR Code pairing between your Android device and Windows PC to safeguard your accounts.",
            featureContactsTitle: "Funnel & Tag management",
            featureContactsDesc: "Segment leads into groups, apply multi-tier tags, and track interaction history in detail.",
            requirementsHeading: "Requirements & notes",
            requirementWindows: "Windows 10 or newer, 64-bit.",
            requirementAndroid: "Android: Android 8.0+ for running the connector pairing app.",
            requirementZalo: "Personal Zalo account or Zalo Official Account.",
            requirementMemory: "Minimum 4GB RAM, 8GB RAM recommended.",
            requirementSize: "Lightweight Windows client ~80MB."
          }
        },
        vocab: {
          title: "VocabFlip",
          ...
          page: {
            ...
            downloadTitle: "Experience & Download App",
            downloadDesc: "Study directly on the Web or download the Windows and Android APK installer for offline learning.",
            downloadWindows: "Download for Windows",
            ...
            releaseDate: "Updated {{date}}",
            updateNote: "Supports offline storage, learning progress synchronization, and automatic updates when a new version is released.",
            screenshotsHeading: "Inside the app",
            prevShot: "Previous screenshot",
            nextShot: "Next screenshot",
            shot1: "Diverse community and personal vocabulary decks library",
            shot2: "Multiple-choice flashcard review combined with FSRS spaced repetition",
            shot3: "Kanji stroke-by-stroke handwriting practice",
            shot4: "Fast built-in offline StarDict dictionary lookup",
            featuresHeading: "Highlights",
            ...
            featureFsrsTitle: "FSRS Spaced Repetition",
            featureFsrsDesc: "Optimizes the forgetting curve, automatically reminding you at the optimal moment to boost recall by 10x.",
            featureImportTitle: "Anki & Excel Import/Export",
            featureImportDesc: "Easily import and export deck files from Anki, Excel, and CSV smoothly.",
            requirementsHeading: "Requirements & platforms",
            requirementWeb: "Web browser: Modern Chrome, Edge, Firefox, Safari (no installation required).",
            requirementOs: "Windows 10 or newer, 64-bit (installer or portable).",
            requirementAndroid: "Android: Android 8.0 or newer, optimized for phones and tablets.",
            requirementAlgorithm: "Modern FSRS-4.5 algorithm locks vocabulary into long-term memory.",
            requirementSize: "Lightweight download ~50MB, full offline dictionary lookup with no internet required.",
