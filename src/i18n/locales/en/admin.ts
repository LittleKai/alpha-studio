export default {
  admin: {
    ...
    users: {
      ...
      topupCreditsPlaceholder: "Credit amount",
      topupNotePlaceholder: "Note (reason)",
      topupBtn: "Top-up",
      topupInvalidCredits: "Invalid credit amount",
      clearFilters: "Clear Filters",
      filterResults: "Showing {count} / {total} users",
      noUsers: "No matching users found",
      selectUserHint: "Select a user to view details",
